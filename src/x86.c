...
const struct x86 X86[X86_COUNT] = {
  ...
  { "imul   "                 , { 0x0f, 0xaf       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "mov    "                 , { 0x8b             }, 1, 1, 0, 0, I_386, INT, ALG },
  { "xchg   "                 , { 0x87             }, 1, 1, 0, 0, I_386, INT, ALG },
  { "xor    "                 , { 0x33             }, 1, 1, 0, 0, I_386, INT, BIT },
  { "xor    "                 , { 0x81             }, 1, 1, 6, 4, I_386, INT, BIT },
  { "xadd   "                 , { 0x0f, 0xc1       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "shr     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 5, 1, I_386, INT, ALG },
  { "shl     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 4, 1, I_386, INT, ALG },
  { "or     "                 , { 0x0b             }, 1, 1, 0, 0, I_386, INT, ALG },
  { "and    "                 , { 0x23             }, 1, 1, 0, 0, I_386, INT, ALG },
  { "and     0x%08" PRIx32 ",", { 0x81             }, 1, 1, 4, 4, I_386, INT, ALG },
  { "neg    "                 , { 0xf7             }, 1, 1, 3, 0, I_386, INT, ALG },
  { "not    "                 , { 0xf7             }, 1, 1, 2, 0, I_386, INT, ALG },
  { "sub    "                 , { 0x29             }, 1, 1, 0, 0, I_386, INT, ALG },
  { "sub     0x%08" PRIx32 ",", { 0x81             }, 1, 1, 5, 4, I_386, INT, ALG },
  ...
  { "cmpxchg"                 , { 0x0f, 0xb1       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "rcl     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 2, 1, I_386, INT, BIT },
  { "rcr     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 3, 1, I_386, INT, BIT },
  { "rol     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 0, 1, I_386, INT, BIT },
  { "ror     0x%02" PRIx8 "," , { 0xc1             }, 1, 1, 1, 1, I_386, INT, BIT },
  { "cmova  "                 , { 0x0f, 0x47       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovb  "                 , { 0x0f, 0x42       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovbe "                 , { 0x0f, 0x46       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovc  "                 , { 0x0f, 0x42       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmove  "                 , { 0x0f, 0x44       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovg  "                 , { 0x0f, 0x4f       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovge "                 , { 0x0f, 0x4d       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovl  "                 , { 0x0f, 0x4c       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovle "                 , { 0x0f, 0x4e       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovna "                 , { 0x0f, 0x46       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnae"                 , { 0x0f, 0x42       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnb "                 , { 0x0f, 0x43       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnbe"                 , { 0x0f, 0x47       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnc "                 , { 0x0f, 0x43       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovne "                 , { 0x0f, 0x45       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovng "                 , { 0x0f, 0x4e       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnge"                 , { 0x0f, 0x4c       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnl "                 , { 0x0f, 0x4d       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnle"                 , { 0x0f, 0x4f       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovno "                 , { 0x0f, 0x41       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnp "                 , { 0x0f, 0x4b       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovns "                 , { 0x0f, 0x49       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovnz "                 , { 0x0f, 0x45       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovo  "                 , { 0x0f, 0x40       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovp  "                 , { 0x0f, 0x4a       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovpe "                 , { 0x0f, 0x4a       }, 2, 1, 0, 0, I_386, INT, ALG },
  { "cmovpo "                 , { 0x0f, 0x4b       }, 2, 1, 0, 0, I_386, INT, ALG },
 ...
 */
  ...
  { "fistp   0x8(%%ebp)"      , { 0xdb, 0x5d, 0x08 }, 3, 0, 0, 0, I_87,  FLT, ALG },
#if 0
  ...
  { "fsincos"                 , { 0xd9, 0xfb       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fscale"                  , { 0xd9, 0xfd       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fsin"                    , { 0xd9, 0xfe       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcos"                    , { 0xd9, 0xff       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  ...
  { "fcomi   %%st,%%st(1)"    , { 0xdb, 0xf1       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcomip  %%st,%%st(1)"    , { 0xdf, 0xf1       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fucomi  %%st,%%st(1)"    , { 0xdb, 0xe9       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fucomip %%st,%%st(1)"    , { 0xdf, 0xe9       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "ficom   %%st(0),0x8(%%ebp)",{0xda, 0x55, 0x08 }, 3, 0, 0, 0, I_87,  FLT, ALG },
  { "ficomp  %%st(0),0x8(%%ebp)",{0xda, 0x5d, 0x08 }, 3, 0, 0, 0, I_87,  FLT, ALG },
  { "fcmovb  %%st(0),%%st(1)" , { 0xda, 0xc1       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcmove  %%st(0),%%st(1)" , { 0xda, 0xc9       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcmovbe %%st(0),%%st(1)" , { 0xda, 0xd1       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcmovu  %%st(0),%%st(1)" , { 0xda, 0xd9       }, 2, 0, 0, 0, I_87,  FLT, ALG },
  { "fcmovnb %%st(0),%%st(1)" , { 0xdb, 0xc1       }, 2, 0, 0, 0, I_87,  FLT, ALG },
